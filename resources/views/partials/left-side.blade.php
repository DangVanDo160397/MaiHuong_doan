  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="{{ route('tour-tour.index') }}">
            <i class="fa fa-th"></i> <span>Quản lý tour</span>
          </a>
        </li>

        <li>
          <a href="{{ route('dat-tour.index') }}">
            <i class="fa fa-th"></i> <span>Đặt tour</span>
          </a>
        </li>
        ...
        <li>
          <a href="{{ route('khuyen-mai.index') }}">
            <i class="fa fa-th"></i> <span>Quản lý khuyến mại</span>
          </a>
        </li>

        <li>
          <a href="{{ route('dia-diem.index') }}">
            <i class="fa fa-th"></i> <span>Quản lý địa điểm</span>
          </a>
        </li>

        <li>
          <a href="{{ route('thanh-toan.index') }}">
            <i class="fa fa-th"></i> <span>Thanh Toán</span>
          </a>
        </li>
        ...
        <li>
         ...
         <li>
          <a href="{{ route('thiet-lap.index') }}">
            <i class="fa fa-th"></i> <span>Thiết lập</span>
          </a>
        </li>
